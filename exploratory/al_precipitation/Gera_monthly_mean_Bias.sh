...
DIR_BASE=/lustre/projetos/monan_gam/andre.lyra/NetCDFs/precip_24h/Bias
ANO=2026
MES=01
...
for PRAZO in 24 48 72 96 120; do
  ...
  LISTA="listas_medias/arquivos_media_${ANO}${MES}_${PRAZO}h.txt"
  : > ${LISTA}
  ...
  cdo ensmean $(cat ${LISTA}) ${DIR_BASE}/Bias_MONAN_Prec_${ANO}${MES}_mean_${PRAZO3}h.nc
