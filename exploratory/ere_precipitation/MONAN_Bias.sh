...
for prazo in $(seq 24 24 ${PRAZO_MAX}); do
    ...
    IMG_GPM="${BASE_BIAS}/diff_${MODEL_NAME}_GPM_${dom}_${PRAZO3}h.png"
    IMG_GSMAP=${BASE_BIAS}/"diff_${MODEL_NAME}_GSMAP_${dom}_${PRAZO3}h.png"
    IMG_MSWEP=${BASE_BIAS}/"diff_${MODEL_NAME}_MSWEP_${dom}_${PRAZO3}h.png"
    ...
    # Arquivo de saida
    OUT="Bias_${MODEL_NAME}_${dom}_${PRAZO3}.png"
